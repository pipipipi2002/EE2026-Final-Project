...
//        if (hide && (cX >= 18 && cX <= 77 && cY >= 20 && cY <= 43)) begin
...
//    assign oled_data = oled_data_B;
    ...
    /* !!!!! COMMENT THIS LINE ONWARDS TO SHOW THE 4.2C !!!!!*/
//    /* 4.2C */
...
//    assign oled_data = oled_data_A | oled_data_B;
