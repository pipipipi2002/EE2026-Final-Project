...
set_property PACKAGE_PIN U1 [get_ports sub_4hide]					
	set_property IOSTANDARD LVCMOS33 [get_ports sub_4hide]
set_property PACKAGE_PIN T1 [get_ports sub_4AorB]					
	set_property IOSTANDARD LVCMOS33 [get_ports sub_4AorB]
set_property PACKAGE_PIN R2 [get_ports sub_4]					
	set_property IOSTANDARD LVCMOS33 [get_ports sub_4]
...
#set_property PACKAGE_PIN L1 [get_ports {ledset}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledset}]
...
set_property PACKAGE_PIN T18 [get_ports pb_u]						
	set_property IOSTANDARD LVCMOS33 [get_ports pb_u]
...
set_property PACKAGE_PIN U17 [get_ports pb_d]						
	set_property IOSTANDARD LVCMOS33 [get_ports pb_d]
...
set_property PACKAGE_PIN M18 [get_ports {JX[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[1]}]
##Sch name = JC3
